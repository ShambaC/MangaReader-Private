...
module.exports = {
    ...
    execute(client, message, args) {
        ...
        embed.addField('Invite', '[Invite the bot here](https://discord.com/api/oauth2/authorize?client_id=916625445993209866&permissions=275414829056&scope=bot%20applications.commands)', true);
